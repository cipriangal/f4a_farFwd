...
void beamPipeRP()
{
  ...
  length[0]            = 8500.0; //17500.0;//16500; //23212.8;
  inRadius1[0]          = 170.0; //168.0; //inner radius
  outRadius1[0]         = 171.0; //170.0; //outer radius
  inRadius2[0]          = 170.0; //168.0; //inner radius
  outRadius2[0]         = 171.0; //170.0; //outer radius
  xCenter[0]           = 830.0;//750.0;
  yCenter[0]           = 0.0;
  zCenter[0]           = 25500;//24000; //30315.0;

	
  //CDR
  length[1]            = 11500; //17500.0;//16500; //23212.8;
  inRadius1[1]          = 170.0; //168.0; //inner radius
  outRadius1[1]         = 171.0; //170.0; //outer radius
  inRadius2[1]          = 70.0; //168.0; //inner radius
  outRadius2[1]         = 71.0; //170.0; //outer radius
  xCenter[1]           = 1300.0;
  yCenter[1]           = 0.0;
  zCenter[1]           = 35500; //CDR
  ...
  beamPipe->GetTransparencyTable()->AddPatternMatch("RPBeamPipe", 40);
